...
public class MockEntity {
    ...
    public static CouponGroup testCouponGroup(Event event) {
        return CouponGroup.of("제주 서귀포 숙박 할인권", "제주 서귀포", CouponType.ACCOMMODATION, "1234", 10, LocalDate.now(), LocalDate.now().plusMonths(1), "/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png", "/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png", event);
    }

    public static CouponGroup testCouponGroup2(Event event) {
        return CouponGroup.of("제주 서귀포 다이빙 체험 할인권", "제주 서귀포", CouponType.SCUBA_DIVING, "1234", 10, LocalDate.now(), LocalDate.now().plusMonths(1), "/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png", "/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png", event);
    }
    ...
    public static Event testEvent() {
        return Event.of("FF0770EF", "FFEBF4FE", "/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png", "/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png");
    }
    ...
    public static List<MarineOrganismImage> testMarineOrganismImage() {
        ...
        marineOrganismImageList.add(MarineOrganismImage.of("/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png"));
    ...
    public static List<HarmfulOrganismImage> testHarmfulOrganismImage() {
        ...
        harmfulOrganismImageList.add(HarmfulOrganismImage.of("/images/0ece1ea4-f4ae-44a7-952c-1702e937422810_제주_서귀포_콘텐츠_상세페이지_이미지.png"));
